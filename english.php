...
<?php include "header.php"; ?>
	...
	<div>	
	<div class="main_img">
						<button class="main_hoo_off" id="hoo"><img src="hoohoo.jpg" alt="hoohoo" style="width: 110px; height: auto;"></button>
						<button class="main_hoo_on" onclick= "hooOn()"><img src="owl.jpg" alt="owl" style="width: 120px; height: auto;"></button>
					</div>
