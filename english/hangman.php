...
<?php
		...
		echo '<table style="float: right;">';
			echo '<tr>';
				...
				echo '<td style="width:305px;"><b>Your chances left: </b><input style="border: none; background-color: #F5D08A; font-size:25pt;" type="button" id="tryleft" value="❤️❤️❤️"><td>';
				echo '<td></td>';				
			echo '</tr>';
		echo '</table>';
?>
...
<script type = "text/javascript">
		...
		function flipo(){							
			...
			if (isright == false){
				...
				if (lefttry == 2){
					document.getElementById("tryleft").value = "❤️❤️";
				} 
				if (lefttry == 1){
					document.getElementById("tryleft").value = "❤️";
				}
				if (lefttry == 0){
