...
<script type = "text/javascript">
    ...
    <div class="main">
        <h1>List of Words</h1>
		<br>
	<div style="border-radius: 8px; border: 2px solid black; display:inline-block;">
<?php
...
// 		$numofwords = count((is_countable($words)?$words:[]));
		...
		if($words){
			...
			for($n = $startnum; $n < $startnum + $numofshow; $n++){
				echo '<tr>';
					echo '<td style="width: 70px; text-align: center;" font-size: 11pt;">' . $num . '</td>';
					echo '<td style="width: 600px; font-size: 11pt;">' . $words[$n]->getEngword() . '</td>';
					echo '<td style="width: 600px; font-size: 11pt;">' . $words[$n]->getKorword() . '</td>';	
					echo '<td>
