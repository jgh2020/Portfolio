...
?>
	...
	<div class="main" style = "background-color : #F5D08A;">
		...
		<br>
	<div style="background-color:sandybrown; height:440px; border-radius: 8px; border: 2px solid white;">
...
<?php		
		...
		function generate(){
			...
			echo '<h4 style="color: white; margin: 10px; text-align: center;">"Please check the numbers and wait until five stars blink!!"</h4>';
			...
			echo '<table style="margin-left: auto; margin-right: auto;">';
				echo '<tr >';				
					echo '<td style="font-size:20pt;" class="star" id="star">Chance of winning</td>';
						$rannum = rand(3, 5);
